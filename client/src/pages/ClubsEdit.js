...
*
* actionsTeachers.findBy_clubs
*	@description CRUD ACTION findBy_clubs
*	@param Objectid key - Id of model to search for
*
* actionsStudents.findBy_clubs
*	@description CRUD ACTION findBy_clubs
*	@param Objectid key - Id of model to search for
*
* actionsClasses.list
...
class ClubsEdit extends Component {
  ...
  componentDidMount() {
    if (this.props.match.params.id !== "new") {
      ...
      this.props.actionsEvents.findBy_clubs(this.props.match.params.id);
      this.props.actionsStudents.findBy_clubs(this.props.match.params.id);
      this.props.actionsTeachers.findBy_clubs(this.props.match.params.id);
    }
      ...
      <div>
        ...
        <form className="myForm" onSubmit={this.save.bind(this)}>
          ...
          <TextField
            id="number"
            label="Number"
            value={this.state.clubs.number || ""}
            onChange={Utils.handleChange.bind(this, "clubs")}
            type="number"
            margin="normal"
            fullWidth
            required
            {...(!this.state.clubs.number && this.state.clubs.number === ""
              ? { error: true }
              : {})}
          />
