    ...
    return (
      <div>
        ...
        <form className="myForm" onSubmit={this.save.bind(this)}>
          ...
          {/* Relation m:m _classes with Classes */}
          
          <FormControl fullWidth className="mb-20">
            <InputLabel htmlFor="_classes">_classes</InputLabel>
            <Select
              multiple
              value={this.state.students._classes || []}
              onChange={Utils.handleChangeSelect.bind(this, "students")}
              input={<Input id="_classes" name="_classes" />}
            ...
            >
              {this.props.listClasses && this.props.listClasses.map(item => (
                <MenuItem
                  ...
                  style={{
                    fontWeight:
                      this.state.students._classes &&
                      this.state.students._classes.indexOf(item._id) === -1
                        ? "regular"
                        : "bold"
                  }}
                >
          ...
          {/* Relation m:m _clubs with Clubs */}
          
          <FormControl fullWidth className="mb-20">
            <InputLabel htmlFor="_clubs">_clubs</InputLabel>
            <Select
              multiple
              value={this.state.students._clubs || []}
              onChange={Utils.handleChangeSelect.bind(this, "students")}
              input={<Input id="_clubs" name="_clubs" />}
              renderValue={selected => (
                <div>
                  {selected.map(value => (
                    <Chip key={value} label={value} />
            ...
            >
              {this.props.listClubs && this.props.listClubs.map(item => (
                <MenuItem
                  ...
                  style={{
                    fontWeight:
                      this.state.students._clubs &&
                      this.state.students._clubs.indexOf(item._id) === -1
                        ? "regular"
                        : "bold"
                  }}
                >
