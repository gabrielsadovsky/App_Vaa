...
*
* actionsTeachers.findBy_classes
*	@description CRUD ACTION findBy_classes
*	@param Objectid key - Id of model to search for
*
* actionsStudents.findBy_classes
*	@description CRUD ACTION findBy_classes
*	@param Objectid key - Id of model to search for
*
...
class ClassesEdit extends Component {
  ...
  componentDidMount() {
    if (this.props.match.params.id !== "new") {
      ...
      this.props.actionsStudents.findBy_classes(this.props.match.params.id);
      this.props.actionsTeachers.findBy_classes(this.props.match.params.id);
    }
      ...
      <div>
        ...
        <form className="myForm" onSubmit={this.save.bind(this)}>
          ...
          <TextField
            ...
            fullWidth
            required
            {...(!this.state.classes.days && this.state.classes.days === ""
              ? { error: true }
              : {})}
          />
          ...
          <TextField
            ...
            fullWidth
            required
            {...(!this.state.classes.vacancies && this.state.classes.vacancies === ""
              ? { error: true }
              : {})}
          />
          ...
          {/* Relation m:m _student with Students */}
          ...
          <FormControl fullWidth className="mb-20">
            ...
            >
              {this.props.listStudents && this.props.listStudents.map(item => (
                <MenuItem
                  key={item._id}
                  value={item._id}
                  style={{
