    ...
    return (
      <div>
        ...
        <form className="myForm" onSubmit={this.save.bind(this)}>
          ...
          {/* Relation 1:m _classes with Classes */}
          
          <FormControl fullWidth className="mb-20">
            <InputLabel shrink htmlFor="_classes">
              _classes
            </InputLabel>
            <Select
              value={this.state.teachers._classes || ""}
          ...
          <FormControl fullWidth className="mb-20">
            ...
            <Select
              multiple
              value={this.state.teachers._clubs || []}
              onChange={Utils.handleChangeSelect.bind(this, "teachers")}
            ...
            >
              {this.props.listClubs && this.props.listClubs.map(item => (
                <MenuItem
                  ...
                  style={{
                    fontWeight:
                      this.state.teachers._clubs &&
                      this.state.teachers._clubs.indexOf(item._id) === -1
                        ? "regular"
                        : "bold"
                  }}
                >
